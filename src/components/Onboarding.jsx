...
export default function Onboarding({ onClose }) {
  ...
  return createPortal(
    <>
      ...
      <style>{`@keyframes ob-pulse{0%,100%{box-shadow:0 0 0 9999px rgba(10,12,14,.82),0 0 0 3px var(--accent)}50%{box-shadow:0 0 0 9999px rgba(10,12,14,.82),0 0 0 5px var(--accent),0 0 16px 4px rgba(17,112,128,.45)}}`}</style>
        ...
        <div style={{
          ...
          {current.navLabel && (
            <div style={{
              ...
              background: 'rgba(17,112,128,.14)',
              border: '1px solid rgba(17,112,128,.28)',
              borderRadius: 20,
              color: 'var(--accent)',
              fontSize: '0.7rem',
              fontWeight: 700,
